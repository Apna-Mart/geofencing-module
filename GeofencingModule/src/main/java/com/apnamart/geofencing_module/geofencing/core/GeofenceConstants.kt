...
object GeofenceConstants {
    ...
    const val SCHEDULE_WORKER_AFTER_INITIAL_DELAY_ONE_TIME_WORKER_JOB = "schedule_worker_after_delay_service_one_time_worker_job"
    const val SCHEDULE_WORKER_AFTER_INITIAL_DELAY_ONE_TIME_WORKER = "schedule_worker_after_delay_one_time_worker"
